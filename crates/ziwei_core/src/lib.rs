...
//! ## 权威契约
//!
//! 输入与查询语义以仓库 `CONTEXT.md` 与 `docs/adr/0001`–`0010` 为准。
...
pub use view::{
    DecadeIndex, DecadeIndexError, DecadeStep, DecadeYear, DecadeYearsError, ZiweiView,
};
pub use year_transformation::YearTransformation;
pub use ziwei::Ziwei;
